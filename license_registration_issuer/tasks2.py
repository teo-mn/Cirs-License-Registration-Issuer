...
#     logger.info('Register license task: ' + str(id))
#     try:
...
#     logger.info('Revoke license task: ' + str(id))
#     try:
...
#     logger.info('Update license task: ' + str(id))
#     try:
...
#     logger.info('Add requirement task: ' + str(id))
#     try:
...
#     logger.info('Remove requirement task: ' + str(id))
#     try:
